    ...
    <div className="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:items-stretch">
      <div className="grid place-content-center rounded bg-gray-100 p-6 sm:p-8">
        <div className="mx-auto max-w-md text-center lg:text-left">
          <header>
            <h2 className="text-xl font-bold text-gray-900 sm:text-3xl">Direct Advertising</h2>

            <p className="mt-4 text-gray-500">
            Direct ads are performance-driven placements. Built to generate traffic for brands and convert on customer acquisition KPIs
            </p>
          </header>
    ...
    <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
      ...
      <div className="grid gap-5 mb-8 md:grid-cols-2 lg:grid-cols-3">
        <div className="p-5 duration-300 transform bg-white border rounded shadow-sm hover:-translate-y-2">
          ...
          <h6 className="mb-2 font-semibold leading-5">All Creative Professionals</h6>
        ...
        <div className="p-5 duration-300 transform bg-white border rounded shadow-sm hover:-translate-y-2">
          ...
          <h6 className="mb-2 font-semibold leading-5">Targeting Capability</h6>
          <p className="text-sm text-gray-900">
        ...
        <div className="p-5 duration-300 transform bg-white border rounded shadow-sm hover:-translate-y-2">
          ...
          <h6 className="mb-2 font-semibold leading-5">Up to 2.00% clickthrough rate</h6>
          <p className="text-sm text-gray-900">
